...
AND COMMUNICATION TECHNOLOGIES -- SOUSSE}}\\[0.2cm]

\vspace{0.3cm}

% ===================== LOGO =====================
\includegraphics[width=3cm]{isitcom.PNG}\\[0.4cm]

% ===================== MAIN TITLE =====================
{\Large \textbf{Final Year Internship Report}}\\[0.3cm]

{\small Submitted in partial fulfillment of the requirements for the degree of}\\
{\small \textbf{Bachelor of Computer Science}}\\[0.15cm]

{\small Specialization: Computer Science and Multimedia}\\[0.5cm]
...
\parbox{0.7\textwidth}{
\centering
\textbf{PRO-WISE PLATFORM}\\[0.15cm]
...
% ===================== AUTHORS =====================
{\small \textbf{Presented by:}}\\[0.2cm]
Ahmed Abderrahmen Jatlaoui\\[0.4cm]

% ===================== SUPERVISORS =====================
\begin{flushleft}
\small
\textbf{Academic Supervisor:} Mr. Abdelweheb Gueddess\\
\textbf{Industrial Supervisor:} Mr. Raouf Bouneb
\end{flushleft}

\vspace{0.3cm}

% ===================== COMPANY =====================
{\small \textbf{Host Company}}\\[0.2cm]

\includegraphics[width=3.5cm]{accelerant.PNG}\\[0.3cm]
\textbf{Accelerant}
...
% ===================== YEAR =====================
{\small Academic Year: 2025/2026}\\[0.2cm]

% ===================== FOOTER =====================
\begin{center}
\footnotesize
Higher Institute of Computer Science and Communication Technologies, Sousse\\
...
\centering
\textbf{Academic Supervisor}\\[1.5cm]
\rule{5cm}{0.4pt}\\[0.2cm]
Mr. Abdelweheb Gueddess
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
\centering
\textbf{Industrial Supervisor}\\[1.5cm]
\rule{5cm}{0.4pt}\\[0.2cm]
Mr. Raouf Bouneb
\end{minipage}
...
This report is my final submission to end my learning. Firstly, I wish to acknowledge my gratitude and dedicate this piece of work to all those who have supported me during the implementation of this project.

\vspace{0.8cm}

Mom and dad, thank you for your love and sacrifices. It was your unchanging support that gave me the fortitude to see things through at times when my studies were most difficult.

\vspace{0.8cm}

To my family, for never doubting me and for the motivation you provided to get me across the line with my engineering degree.

\vspace{0.8cm}

I am grateful to my teachers for the knowledge and guidance you have shown me over the years. Thank you for your role in my development as a student.

\vspace{0.8cm}

And to my friends, for the long hours we put in studying side by side, for lending a hand and for some good times along the way.

\vspace{0.8cm}

To wrap up, I am also very grateful to those who have given me words of encouragement or have provided some technical advice when I was in the need of it. Thank you all very much.
...
First of all, I genuinely appreciate all the efforts of the people who have assisted me during this project.

\vspace{1cm}

My first and greatest thanks go to my academic supervisor, \textbf{Mr. Abdelweheb Gueddess}, for his priceless help, unlimited advices, and always insightful inputs.

\vspace{1cm}

Besides that, I am most grateful to my industrial supervisor, \textbf{Mr. Raouf Bouneb}, for the support, guidance, and cheer he gave me.

\vspace{1cm}

Many thanks to the Accelerant team for giving me a professional and inspiring atmosphere.

\vspace{1cm}

Last but not least, I am very grateful to my family and friends for their ongoing support and motivation.
...
Figure~\ref{fig:gantt_planning} presents the overall planning of the PRO-WISE project. It shows the main development phases and how the tasks were distributed across the different sprints. This schedule helped us organize the work, follow the project progress, and ensure that each part was completed within the planned time.
...
\centering
\small
\caption{Product Backlog of PRO-WISE Platform}
\label{tab:product_backlog}
\begin{tabular}{p{0.7cm}p{3.1cm}p{8.1cm}p{1.4cm}}
\toprule
...
\centering
\small
\caption{Product Backlog of PRO-WISE Platform -- continued}
\begin{tabular}{p{0.7cm}p{3.1cm}p{8.1cm}p{1.4cm}}
\toprule
\textbf{ID} & \textbf{Feature / Epic} & \textbf{Description} & \textbf{Priority} \\
\midrule
14 & Similar Products & Display of related products within product pages & Medium \\
15 & Search System & Semantic search for products and content using Gemini embeddings and semantic similarity ranking & Medium \\
...
The PRO-WISE application architecture is presented through two complementary views: the MVC logical architecture, which explains how the internal code is organized, and the global architecture, which shows how users, clients, backend services, database storage, and AI services interact.

\subsubsection{MVC Architecture}

PRO-WISE follows the MVC (Model-View-Controller) pattern~\cite{mvc}, as shown in Figure~\ref{fig:mvc_architecture}. The Model manages data and database operations, the View represents the user interface, and the Controller handles user requests and connects the View with the Model. This structure keeps the application organized and easier to maintain.

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{mvc.png}
\caption{MVC architecture of the PRO-WISE application}
\label{fig:mvc_architecture}
\end{figure}

\subsubsection{Global Architecture}

The global architecture in Figure~\ref{fig:global_architecture} shows how PRO-WISE works end-to-end. A user accesses the web or mobile client, scans a product QR code, and sends requests to the backend API. The backend processes these requests, applies the business logic, communicates with MongoDB for data storage, and uses the Google Gemini API for intelligent search and assistance. The frontend is deployed on Vercel, while the backend API is deployed on Render.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{Archetecture.png}
\caption{Global architecture of the PRO-WISE platform}
...
The tools used in this project cover both development and deployment. They helped us build the frontend, backend, mobile application, database, AI features, diagrams, and online hosting.
...
\midrule
\techlogo{react.png} & React~\cite{react} & Development of the dynamic web client interface. \\
\techlogo{expo (1).png} & React Native / Expo~\cite{reactnative,expo} & Development and testing of the cross-platform mobile application. \\
\techlogo{sails.png} & Sails.js~\cite{sailsjs} & Backend REST API, controllers, services, and business logic. \\
\techlogo{Mongodb.png} & MongoDB~\cite{mongodb} & NoSQL database used for persistent and flexible data storage. \\
...
\techlogo{images/Vercel.png} & Vercel~\cite{vercel} & Hosting and deployment of the frontend web application. \\
\techlogo{images/Render.png} & Render~\cite{render} & Hosting and deployment of the backend API services. \\
\bottomrule
\end{tabular}
\end{table}
...
Actor & Visitor with an existing account \\
...
Figure~\ref{fig:seq_profile} shows how the profile updates travel from the UI to the database.
 ...
 \subsubsection{Authentication Interfaces}
  ...
  \begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{images/dashbord.PNG}
  \hfill
  \includegraphics[width=0.45\textwidth]{images/Admin Dashbord.PNG}
  \caption{Web interfaces – User and Admin dashboards}
  ...
  \begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.22\textwidth]{images/homepage.jpeg}
  ...
  \begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.22\textwidth]{images/profil.jpeg}
...
\begin{figure}[!htbp]
 \centering
 \includegraphics[width=0.45\textwidth]{images/product.PNG}
 \hfill
 \includegraphics[width=0.45\textwidth]{images/product catalog.PNG}
 \caption{Web interfaces – Product list and product catalog management}
 \label{fig:web_product_list}
 \end{figure}

\begin{figure}[!htbp]
 \centering
 \includegraphics[width=0.45\textwidth]{images/support content .PNG}
 \hfill
 \includegraphics[width=0.45\textwidth]{images/content form.PNG}
 \caption{Web interfaces – Support content view and content submission form}
 \label{fig:web_catalog_moderation}
 \end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.22\textwidth]{images/categories or regestory.jpeg}
\hfill
\includegraphics[width=0.22\textwidth]{images/product details description.jpeg}
\caption{Mobile interfaces – Category directory and product details description}
\label{fig:mobile_catalog}
\end{figure}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{images/company admin feedback.PNG}
  \hfill
  \includegraphics[width=0.45\textwidth]{images/notifications.PNG}
  \caption{Web interfaces – Company admin feedback page and notifications portal}
  \label{fig:web_feedback_notifications}
  \end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.22\textwidth]{images/feedback mobile.jpeg}
\caption{Mobile interface – User feedback submission}
...
\begin{enumerate}
    ...
    \item \textbf{Stage 1: Semantic Filtering}: The system pulls inventory parts from MongoDB, gets their 768-D vectors from the Gemini API, and calculates semantic similarity against the query vector. We discard components scoring below a $0.70$ threshold.
...
We segment technical manuals into small text paragraphs (chunks) and compute their vector embedding using the Gemini API. The database stores these floating-point arrays alongside the raw text. To calculate similarity between the query vector and document chunks, the backend calculates the similarity score (semantic similarity) between their embedding vectors. 
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{images/search.PNG}
  \hfill
  \includegraphics[width=0.45\textwidth]{images/match component instruction.PNG}
  \caption{Web interfaces -- Semantic search and component matching instructions}
  \label{fig:web_recs}
  \end{figure}

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.22\textwidth]{images/recomendation mobile.jpeg}
\hfill
\includegraphics[width=0.22\textwidth]{images/match component and instruction.jpeg}
\caption{Mobile interfaces – Recommendation system and component matching views}
...
\begin{figure}[!htbp]
 \centering
 \includegraphics[width=0.8\textwidth]{images/technician Portal.PNG}
 \caption{Web interface -- Technician portal request pool}
 ...
 \begin{figure}[!htbp]
  ...
  \hfill
  \includegraphics[width=0.45\textwidth]{images/Become a technician .PNG}
  \caption{Web interfaces -- Maintenance request form and Become a technician page}
  \label{fig:web_requests}
  \end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.38\textwidth]{images/technician Protal.jpeg}
\caption{Mobile interface -- Technician portal job dashboard}
...
\bibitem{vercel}
Vercel Inc. (2026). \textit{Vercel Documentation}. Available online at: \url{https://vercel.com/docs} [Accessed May 2026].

\bibitem{render}
Render Services, Inc. (2026). \textit{Render Documentation}. Available online at: \url{https://render.com/docs} [Accessed May 2026].
...
\bibitem{mvc}
MDN Web Docs. (2026). \textit{MVC (Model-View-Controller) Design Pattern}. Available online at: \url{https://developer.mozilla.org/en-US/docs/Glossary/MVC} [Accessed May 2026].
...
PRO-WISE est né de notre aversion pour les manuels papier. Ils sont encombrants et personne ne les conserve. Et même si vous en avez un sous les yeux, vous devez feuilleter page après page pour trouver l'instruction spécifique à votre problème.
Il suffit d'imprimer un code QR sur l'appareil pour que vous puissiez le scanner avec votre smartphone et recevoir une assistance immédiate.
En scannant le code QR, vous accédez à tout ce qui concerne cet appareil : manuels, pièces de rechange, dépannage. Il y a même une fonction de chat où vous pouvez décrire votre problème et obtenir une réponse tirée directement du manuel de l'appareil, plutôt qu'une FAQ générique.
Le site lui-même est construit avec React, et nous avons utilisé React Native pour le développement mobile afin de partager la logique entre les deux. Pour les données, nous utilisons MongoDB avec un backend Sails.js. De plus, nous avons intégré l'API Google Gemini pour enrichir notre chat RAG et nos fonctionnalités de recherche. En outre, nous avons ajouté un système de rôles où les administrateurs de marque gèrent le catalogue, tandis que les techniciens reçoivent les demandes d'intervention à résoudre.
Notre objectif est de prouver qu'en fournissant à l'utilisateur des informations spécifiques à l'équipement sur lequel il travaille, nous pouvons réduire considérablement le temps de réparation.

\vspace{0.15cm}
\textbf{Mots-clés :} Code QR, Assistance Produit, Application Web, Application Mobile, API Google Gemini
\endgroup
