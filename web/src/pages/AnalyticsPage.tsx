        ...
        <div className="page">
            ...
            {isSuperAdmin && stats?.users && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
                    <Card raised style={{ overflow: 'hidden', padding: 0 }}>
                        <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--color-border)', background: 'rgba(var(--color-primary-rgb), 0.05)' }}>
                            <h3 style={{ margin: 0 }}>User Role Distribution</h3>
                            <p style={{ margin: '0.25rem 0 0', fontSize: '0.875rem', color: 'var(--color-text-muted)' }}>Distribution of active Super Admins, Company Admins, and Technicians.</p>
                        </div>
                    ...
                    <Card raised className="p-6">
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem', background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px' }}>
                    ...
                    {stats.companies?.topCompanies && stats.companies.topCompanies.length > 0 && (
                        <Card raised style={{ overflow: 'hidden', gridColumn: '1 / -1', padding: 0 }}>
                            <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--color-border)', background: 'rgba(var(--color-accent-rgb), 0.05)' }}>
