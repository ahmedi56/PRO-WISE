...
import { Alert, Badge, Button, Card, EmptyState, InputField, Skeleton } from './ui';
...
const AdminProductTable = () => {
    ...
    const fetchProducts = async () => {
        ...
        setError('');
        try {
            const { data } = await axios.get(`${API_URL}/products?manage=true`, config);
                                        ...
                                        <td>
                                            <div className="page-header-actions">
                                                ...
                                                {(() => {
                                                    const userRole = user?.role || user?.Role;
                                                    const permissions = userRole?.permissions || [];
                                                    return permissions.includes('products.manage') && (
                                                        <Button
                                                            variant="danger"
                                                            size="sm"
