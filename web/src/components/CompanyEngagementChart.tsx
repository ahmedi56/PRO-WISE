...
interface CompanyEngagementData {
    name: string;
    visits: number;
}

interface CompanyEngagementChartProps {
    data: CompanyEngagementData[];
}

const CompanyEngagementChart: React.FC<CompanyEngagementChartProps> = ({ data }) => {
    const COLORS = [
        '#6366f1', // Indigo
        '#8b5cf6', // Violet
        '#ec4899', // Pink
            ...
            <ResponsiveContainer width="100%" height="100%">
                ...
                >
                    ...
                    <Tooltip 
                        ...
                        formatter={(value: any) => [`${value} Scans`, 'Engagement']}
                    />
                    <Bar 
                        dataKey="visits" 
                        radius={[6, 6, 0, 0]}
