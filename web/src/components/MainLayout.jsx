...
const CategoryItem = ({ category, depth = 0, currentCategoryId, onCategoryClick }) => {
        ...
        <div className="category-branch">
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', width: '100%', gap: '8px' }}>
                    ...
                    <ion-icon 
                        name={CATEGORY_ICON_MAP[category.name?.toLowerCase()] || category.icon || 'folder-outline'} 
...
const MainLayout = ({ children }) => {
    ...
    const handleCategoryClick = (category) => {
        // If we are on products page, just update params
        // If we are on detail page or category overview, navigate to products
